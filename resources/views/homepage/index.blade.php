...
<head>
    ...
    <!-- Stylesheets
	============================================= -->
    <link href="https://fonts.googleapis.com/css?family=Nunito:300,400,600,700|Playfair+Display:400,700&display=swap"
    ...
    <link rel="stylesheet" href="{!!asset('homepage/css/components/bs-switches.css')!!}" type="text/css" />

    <link rel="stylesheet" href="{!!asset('homepage/css/custom.css')!!}" type="text/css" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <link rel="stylesheet" href="{!!asset('homepage/css/colors.php?color=1f8bc4')!!}" type="text/css" />
    ...
    <!-- Document Title
	============================================= -->
    <title>Articles | sarjanamalam</title>
                    ...
                    <div class="header-row">
                        ...
                        <div id="logo">
                            <a href="index.html" class="standard-logo"
                                data-dark-logo="{!!asset('homepage/asset/articles/images/logo.png')!!}"><img
                                    src="{!!asset('homepage/asset/articles/images/logo.png')!!}"
                                    alt="sarjanamalam Logo"></a>
                            <a href="index.html" class="retina-logo"
                                data-dark-logo="{!!asset('homepage/asset/articles/images/logo@2x.png')!!}"><img
                                    src="{!!asset('homepage/asset/articles/images/logo@2x.png')!!}"
                                    alt="sarjanamalam Logo"></a>
                        </div><!-- #logo end -->
                        ...
                        <nav class="primary-menu">
                            ...
                            <ul class="menu-container">
                                ...
                                <li class="menu-item"><a href="#" class="menu-link ls0" data-scrollto="#footer"
                                        data-highlight="yellow" data-speed="1200">
                                        <div>Contact Us</div>
                                    </a></li>
                            </ul>
                ...
                <div class="swiper-container swiper-parent">
                    <div class="swiper-wrapper">
                            ...
                            <div class="container">
                                <div class="row align-items-center mt-5">
                                    <div class="col-xl-6 pr-0 pr-xl-5 col-md-5 col-sm-11 col-12 mb-5 mb-lg-0">
                                        <div class="heading-block border-bottom-0 mb-4">
                                            <div class="before-heading mb-2">02 February 2021 <span
                                                    class="badge badge-secondary ml-1">Featured</span></div>
                                            <h2 class="font-weight-bold ls0 nott">Complete Recipes for Vegetarians.</h2>
                                        </div>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Assumenda
                                            praesentium eius,
                                            similique reprehenderit ab voluptatibus eaque. Nobis maxime recusandae
                                            aliquid, id
                                        ...
                                        <div
                                            ...
                                            <div class="rating-stars ml-1"><i class="icon-star3"></i><i
                                            ...
                                            <span class="article-price font-weight-bold ml-1"><del>$50.00</del>
                                                $42.00</span>
                                        </div>
                                        <a href="#" class="button button-large nott ml-0"><i
                                                class="icon-shopping-cart1"></i> Add
                                            to Cart</a>
                                    </div>
                                    <div class="col-xl-2 col-md-3 col-4 parallax" data-0="transform: translateY(0px);"
                                        data-600="transform: translateY(-30px);">
                                        <img src="{!!asset('homepage/asset/articles/images/articles/1/1.png')!!}"
                                            alt="Image" class="rounded faster" data-animate="fadeInLeft">
                                    ...
                                    <div class="col-xl-2 col-md-2 col-4 p-0 parallax" data-0="transform: translateY(0);"
                                        ...
                                        <img src="{!!asset('homepage/asset/articles/images/articles/1/4.png')!!}"
                                            alt="Image" class="faster rounded" data-animate="fadeInLeft"
                                            data-delay="200">
                                        <img src="{!!asset('homepage/asset/articles/images/articles/1/2.png')!!}"
                                            alt="Image" class="faster rounded mt-3" data-animate="fadeInLeft"
                                            data-delay="300">
                                    </div>
                                    <div class="col-xl-2 col-md-2 col-4 parallax" data-0="transform: translateY(0px);"
                                        data-600="transform: translateY(-20px);">
                                        <img src="{!!asset('homepage/asset/articles/images/articles/1/3.png')!!}"
                                            alt="Image" class="faster rounded" data-animate="fadeInLeft"
                                            data-delay="400">
                                        <img src="{!!asset('homepage/asset/articles/images/articles/1/5.png')!!}"
                                            alt="Image" class="faster rounded mt-3" data-animate="fadeInLeft"
                                            data-delay="500">
                                    </div>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="container">
                                <div class="row align-items-center mt-5">
                                    <div class="col-xl-6 pr-0 pr-xl-5 col-md-6 col-sm-11 col-12 mb-5 mb-lg-0">
                                        <div class="heading-block border-bottom-0 mb-4">
                                            <div class="before-heading mb-2">16 March 2021 <span
                                                    class="badge badge-secondary ml-1">Featured</span></div>
                                            <h2 class="font-weight-bold ls0 nott">The Darkness of the Flame</h2>
                                        </div>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quam ipsa harum
                                            obcaecati, et
                                            quo facilis itaque minima tempore voluptates suscipit.</p>
                                        <div
                                            class="article-info bottommargin-sm d-flex align-items-center justify-content-between">
                                            <div class="rating-stars ml-1"><i class="icon-star3"></i><i
                                                    class="icon-star3"></i><i class="icon-star3"></i><i
                                            ...
                                            <span class="article-price font-weight-bold ml-1"><del>$60.00</del>
                                                $49.99</span>
                                        </div>
                                        <a href="#" class="button button-large nott ml-0"><i
                                                class="icon-shopping-cart1"></i> Add
                                    ...
                                    <div class="col-xl-3 col-md-3 col-6 parallax" data-0="transform: translateY(0px);"
                                        data-600="transform: translateY(-30px);">
                                        <img src="{!!asset('homepage/asset/articles/images/articles/2/1.png')!!}"
                                            alt="Image" class="rounded" data-animate="faster fadeInLeft">
                                    ...
                                    <div class="col-xl-3 col-md-3 col-6 p-0 parallax" data-0="transform: translateY(0);"
                                        ...
                                        <img src="{!!asset('homepage/asset/articles/images/articles/2/2.png')!!}"
                                            alt="Image" class="rounded" data-animate="faster fadeInLeft"
                                            data-delay="200">
                                    </div>
                                </div>
        ...
        <section id="content">
            ...
            <div class="content-wrap pb-0 clearfix">
                        ...
                        <div class="row justify-content-start justify-content-sm-center justify-content-md-start">
                            <div class="col-lg-4 col-md-6">
                                <div class="heading-block services-info pr-1">
                                    <h2 class="font-weight-normal ls0 nott font-primary">Our Services</h2>
                        ...
                        <div class="row align-items-md-center mt-3">
                                    ...
                                    <div class="card-body rounded">
                                        <div class="feature-box media-box">
                                            ...
                                            <div class="fbox-content">
                                                <h3 class="font-weight-normal ls0 nott">25+ Multiple Languages.</h3>
                            ...
                            <div class="col-md-4 px-lg-4 mt-3 mt-md-0">
                                <div class="card border-color-pink p-2 py-lg-5 px-xl-3 px-lg-2">
                                    <div class="card-body rounded">
                                        <div class="feature-box media-box">
                                            <div class="fbox-icon position-relative mb-3"
                                                style="width: 50px;height: 50px">
                                                <svg enable-background="new 0 0 464.585 464.585"
                                                    viewBox="0 0 464.585 464.585" xmlns="https://www.w3.org/2000/svg">
                                                    <path
                                                    ...
                                                    <path d="m119.272 150.387h15v26.354h-15z" /></svg>
                                            </div>
                                            <div class="fbox-content">
                                                <h3 class="font-weight-normal ls0 nott">32+ Categories Available.</h3>
                                                <p class="text-muted">Lorem ipsum dolor sit amet, consectetur
                                                    adipisicing elit.
                                                    Eligendi rem, facilis nobis voluptatum.</p>
                                                <a href="#" class="btn btn-link font-body mt-3 p-0">Read More..</a>
                                        ...
                                        <div class="feature-box media-box">
                                            <div class="fbox-icon position-relative mb-4"
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <svg width="32" height="32" class="ml-3" viewBox="0 0 512 512"
                                                        xmlns="https://www.w3.org/2000/svg">
                                                        <path
                                            ...
                                            <div class="fbox-content">
                                                <h3 class="font-weight-normal nott ls0">On Social Networks.</h3>
                                                <p class="text-muted">Lorem ipsum dolor sit amet, consectetur
                                                    adipisicing elit.
                                                    Eligendi rem, facilis nobis voluptatum.</p>
                                                <a href="#" class="btn btn-link font-body mt-3 p-0">Read More..</a>
                                ...
                                <div class="card border-color-info p-2 py-lg-5 px-xl-3 px-lg-2">
                                    <div class="card-body rounded">
                                        <div class="feature-box media-box">
                                            <div class="fbox-icon position-relative mb-3"
                                                style="width: 50px;height: 50px">
                                                <svg enable-background="new 0 0 496.592 496.592"
                                                    viewBox="0 0 496.592 496.592" xmlns="https://www.w3.org/2000/svg">
                                                    <path
                                            ...
                                            <div class="fbox-content">
                                                <h3 class="font-weight-normal ls0 nott">Full Customer Satisfaction.</h3>
                                                <p class="text-muted">Lorem ipsum dolor sit amet, consectetur
                                                    adipisicing elit.
                                                    Eligendi rem, facilis nobis voluptatum.</p>
                                                <a href="#" class="btn btn-link font-body mt-3 p-0">Read More..</a>
                ...
                <div class="section m-0 section-scroller" style="padding: 100px 0">
                    <div class="container center">
                        ...
                        <div class="heading-block border-bottom-0 mx-auto" style="max-width: 820px">
                            <h2 class="nott ls0 font-weight-normal">Rapidiously pontificate tactical information visa
                                installed
                                base platforms.</h2>
                            <a href="#" class="button button-large nott px-5 ml-0 mt-4 clearfix">View All</a>
                        </div>
                    </div>
                            ...
                            <div class="swiper-wrapper h-auto">
                                        ...
                                        <div class="col-md-6 p-0">
                                            <div class="card">
                                                <div class="card-body py-4">
                                                    <h4 class="mb-3"><a href="#">Yanagi sarjanamalam</a></h4>
                                                    <p class="mb-3 d-none d-sm-block">Proactively empower flexible
                                                        partnerships
                                                        rather than ethical products. Assertively cultivate 2.0 ROI
                                                        before
                                                        standardized processes.</p>
                                                    <div class="article-info mb-3 d-flex align-items-center">
                                                        <div class="rating-stars mr-3"><i class="icon-star3"></i><i
                                                                class="icon-star3"></i><i class="icon-star3"></i><i
                                                    ...
                                                    <span
                                                        class="article-price font-weight-bold ml-1 clearfix"><del>$50.00</del>
                                                        $42.00</span>
                                                    <a href="#"
                                                        class="button button-small button-dark ls0 shadow-none nott ml-0 mt-4 clearfix"><i
                                        ...
                                        <div class="col-md-6 p-0">
                                            <div class="card">
                                                <div class="card-body py-4">
                                                    ...
                                                    <p class="mb-3 d-none d-sm-block">Continually impact viral
                                                        web-readiness before
                                                        client-focused value. Phosfluor brand global action items via
                                                    ...
                                                    <span
                                                        class="article-price font-weight-bold ml-1 clearfix"><del>$39.99</del>
                                                        $29.99</span>
                                                    <a href="#"
                                                        class="button button-small button-dark ls0 shadow-none nott ml-0 mt-4 clearfix"><i
                                                            class="icon-shopping-cart1"></i>Add to Cart</a>
                                ...
                                <div class="swiper-slide">
                                    <div class="row m-auto align-items-center justify-content-center">
                                        <div class="col-md-6 p-0">
                                            <img src="{!!asset('homepage/asset/articles/images/articles/3/1.png')!!}"
                                                alt="Image">
                                        </div>
                                        <div class="col-md-6 p-0">
                                            <div class="card">
                                                <div class="card-body py-4">
                                                    ...
                                                    <span
                                                        class="article-price font-weight-bold ml-1 clearfix">$29.99</span>
                                                    <a href="#"
                                                        class="button button-small button-dark ls0 shadow-none nott ml-0 mt-4 clearfix"><i
                                                            class="icon-shopping-cart1"></i>Add to Cart</a>
                                                </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="row m-auto align-items-center">
                                        <div class="col-md-6 p-0">
                                            <img src="{!!asset('homepage/asset/articles/images/articles/4/1.png')!!}"
                                                alt="Image">
                                        </div>
                                        <div class="col-md-6 p-0">
                                            <div class="card">
                                                <div class="card-body py-4">
                                                    ...
                                                    <span
                                                        class="article-price font-weight-bold ml-1 clearfix">$21.49</span>
                                                    <a href="#"
                                                        class="button button-small button-dark ls0 shadow-none nott ml-0 mt-4 clearfix"><i
                                                            class="icon-shopping-cart1"></i>Add to Cart</a>
                                                </div>
                                        ...
                                        <div class="col-md-6 p-0">
                                            <div class="card">
                                                <div class="card-body py-4">
                                                    ...
                                                    <span
                                                        class="article-price font-weight-bold ml-1 clearfix"><del>$60.00</del>
                                                        $49.99</span>
                                                    <a href="#"
                                                        class="button button-small button-dark ls0 shadow-none nott ml-0 mt-4 clearfix"><i
                                                            class="icon-shopping-cart1"></i>Add to Cart</a>
                                ...
                                <div class="swiper-slide">
                                    <div class="row m-auto align-items-center">
                                        <div class="col-md-6 p-0">
                                            <img src="{!!asset('homepage/asset/articles/images/articles/6/1.png')!!}"
                                                alt="Image">
                                        </div>
                                        <div class="col-md-6 p-0">
                                            <div class="card">
                                                <div class="card-body py-4">
                                                    ...
                                                    <span
                                                        class="article-price font-weight-bold ml-1 clearfix">$11.49</span>
                                                    <a href="#"
                                                        class="button button-small button-dark ls0 shadow-none nott ml-0 mt-4 clearfix"><i
                                                            class="icon-shopping-cart1"></i>Add to Cart</a>
                                                </div>
                ...
                <div class="section section-about m-0"
                    style="padding: 120px 0; background: url('demos/articles/images/dots-1.png')!!}') 100% 0 no-repeat / 40%;">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-5">
                                <h4 class="mb-0"><span class="badge badge-secondary font-body">About Us</span></h4>
                                <div class="heading-block">
                                    <h2 class="font-weight-normal ls0 nott mb-3 font-primary">Objectively network user
                                        friendly
                                        quality with world-class bandwidth. </h2>
                                </div>
                                <p>Progressively strategize just in time scenarios and compelling results. Intrinsicly
                                    parallel
                                    task extensive systems whereas distinctive catalysts for change. Proactively
                                    communicate
                                    standardized paradigms through proactive.</p>
                                <a href="#" class="button button-large ls0 nott ml-0 mt-2 clearfix">Learn More</a>
                            </div>
                                        ...
                                        <div class="row align-items-center justify-content-between h-100">
                                            <div>
                                                <div class="circle-inner">
                                                    <div>
                                                        <div
                                                            class="counter mb-0 font-weight-normal font-body text-primary">
                                            ...
                                            <div class="d-flex h-100 flex-column justify-content-between">
                                                <div class="circle-inner">
                                                    <div>
                                                        <div
                                                            class="counter mb-0 font-weight-normal font-body text-info">
                                                ...
                                                <div class="circle-inner">
                                                    <div>
                                                        <div
                                                            class="counter mb-0 font-weight-normal font-body text-danger">
                                                            <span class="font-body" data-from="1" data-to="1240"
                                                                data-refresh-interval="50" data-speed="2100"></span>
                                                        </div>
                                                ...
                                                <div class="circle-inner">
                                                    <div>
                                                        <div
                                                            class="counter mb-0 font-weight-normal font-body text-warning">
                                                            <span class="font-body" data-from="1" data-to="3"
                                            ...
                                            <div>
                                                <div class="circle-inner">
                                                    <div>
                                                        <div class="counter mb-0 font-weight-normal font-body color">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-5 mt-5 mt-lg-0">
                                ...
                                <div id="oc-images" class="owl-carousel image-carousel carousel-widget" data-margin="20"
                                    ...
                                    <div class="oc-item">
                                        <a href="#"><img
                                                src="{!!asset('homepage/asset/articles/images/articles/1/1.png')!!}"
                                                alt="Image 1"></a>
                                    </div>
                                    <div class="oc-item">
                                        <a href="#"><img
                                                src="{!!asset('homepage/asset/articles/images/articles/1/2.png')!!}"
                                                alt="Image 2"></a>
                                    </div>
                                    <div class="oc-item">
                                        <a href="#"><img
                                                src="{!!asset('homepage/asset/articles/images/articles/2/1.png')!!}"
                                                alt="Image 3"></a>
                                    </div>
                                    <div class="oc-item">
                                        <a href="#"><img
                                                src="{!!asset('homepage/asset/articles/images/articles/4/1.png')!!}"
                                                alt="Image 4"></a>
                                    </div>
                                    <div class="oc-item">
                                        <a href="#"><img
                                                src="{!!asset('homepage/asset/articles/images/articles/6/1.png')!!}"
                                                alt="Image 5"></a>
                                    </div>
                        ...
                        <div class="row align-items-center justify-content-between">
                            ...
                            <div class="col-lg-5 col-md-5 col-sm-6">
                                <div class="heading-block border-bottom-0">
                                    <h2 class="font-weight-normal ls0 nott mb-0 font-primary"
                                        style="font-size: 44px; line-height: 1.3">Available for your smartphone.</h2>
                                </div>
                                <p>Progressively strategize just in time scenarios and compelling results. Intrinsicly
                                    parallel
                                    task extensive systems whereas distinctive catalysts for scenarios and compelling
                                    results
                                    change.</p>
                                <div>
                                    <a href="#"><img src="{!!asset('homepage/asset/articles/images/appstore.png')!!}"
                                            alt="Image" height="54" class="mt-3"></a>
                                    <a href="#"><img src="{!!asset('homepage/asset/articles/images/googleplay.png')!!}"
                                            alt="Image" class="ml-xl-3 ml-lg-1 mt-3 ml-0 " height="54"></a>
                                </div>
                            </div>

                            <div class="col-lg-6 col-md-7 col-sm-6 mt-5 mt-sm-0">
                                <div class="d-none d-lg-flex">
                                    <img src="{!!asset('homepage/asset/articles/images/iphone-1.png')!!}" class="fast"
                                        alt="Image" style="height: 600px" data-animate="fadeInDown">
                                    <img src="{!!asset('homepage/asset/articles/images/iphone-2.png')!!}" class="fast"
                                        alt="Image" style="height: 600px" data-animate="fadeInUp">
                                </div>
                                <img src="{!!asset('homepage/asset/articles/images/iphone.png')!!}" alt="Image"
